...
public class Manager extends Dipendente {
	...
	public Manager(String nome, String cognome, Integer eta, String codiceFiscale, 
			String nazione, String luogoNascita, Double stipendio, Integer livello, String areaResp) {
		super();
